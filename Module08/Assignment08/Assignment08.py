...
# and child class - Readme of TextFile to read data. Made comments to explain
# what  each new code does and created implicit and explicit objFile variable 
# to use to open Products.txt.  
#   
#-------------------------------------------------#
